...
Feature: Updating reminders
  ...
  Background:
        Given there is 1 project with the following:
          ...
          And there is 1 reminder in project "worlddomination" created by "alice" with:
            | title      | reminder 1           |
            | location   | Room 1              |
            | duration   | 1:30                |
            | start_time | 2011-02-11 12:30:00 |
          And "bob" is invited to the reminder "reminder 1"

  Scenario: Adding a new invitee
       When I am already logged in as "alice"
        And I go to the edit page of the reminder called "reminder 1"
