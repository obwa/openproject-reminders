...
class reminderParticipant < ActiveRecord::Base
  ...
  def copy_attributes
    # create a clean attribute set allowing to attach participants to different reminders
    attributes.reject { |k, _v| ['id', 'reminder_id', 'attended', 'created_at', 'updated_at'].include?(k) }
  end
end
